...
public class UConstantes {
	...
	public static final String FORMATO_DATE_NORMAL_HORA_MIN_AM_PM = "dd/MM/yyyy hh:mm a";
	...
	public static final String SALTO_LINEA_ADOBE = "\r\n";
	
	public static final String CONFIG_BIM_ADMIN_EMAIL = "config.bim.admin.email";
	public static final String CONFIG_BIM_EVALES_EMAIL = "config.bim.evales.email";
	...
	public static final String SEPARADOR_SALTO_LINEA_HTML_SIMPLE = "<br>";
	...
	public static final String COSTAMAR_FILTRO_TODOS = "todas";
	public static final int COSTAMAR_ORDENAR_PRECIO = 1;
	public static final int COSTAMAR_ORDENAR_DURACION = 2;
	public static final int COSTAMAR_ORDENAR_PRECIO_DURACION = 3;
	public static final int COSMAMAR_FILTRO_ESCALAS = 2; 
	...
	//MILLAS VARIABLES
	public static final String OPCION_GENERAL_CADENA = "DEFAULT";
	public static final Integer OPCION_GENERAL_INTEGER = 0;
